...
import { ApiResponse, StatusFlags, eMessageType } from './model/data.service.model';
...
export class DataService {
  ...
  postFile<T>(url: string, data: any): Promise<ApiResponse<T>> {
    return new Promise<ApiResponse<T>>((resolve) => {
      ...
      var postFileSubscription: Subscription = this.http.post<ApiResponse<T>>(url, formData).subscribe({
